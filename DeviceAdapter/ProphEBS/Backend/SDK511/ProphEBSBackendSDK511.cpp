///////////////////////////////////////////////////////////////////////////////
// FILE:          ProphEBSBackendSDK511.cpp
// PROJECT:       Micro-Manager
// SUBSYSTEM:     DeviceAdapters / ProphEBS / Backend / SDK511
//-----------------------------------------------------------------------------
// See ProphEBSBackendSDK511.h for the design rationale. This is a 1:1
...
ProphEBSBackendSDK511::~ProphEBSBackendSDK511()
{
   Disconnect();
}

bool ProphEBSBackendSDK511::Connect(bool biasRangeCheckBypass, char* errorOut, size_t errorOutLen)
{
   try
   {
...
void ProphEBSBackendSDK511::Disconnect()
{
   if (connected_)
   {
...
bool ProphEBSBackendSDK511::GetIdentification(ProphEBSIdentification& out)
{
   try
   {
...
void ProphEBSBackendSDK511::RegisterCdCallback(ProphEBSCdCallback cb, void* ctx)
{
   cdCb_ = cb;
   cdCtx_ = ctx;
...
void ProphEBSBackendSDK511::RegisterRawDataCallback(ProphEBSRawDataCallback cb, void* ctx)
{
   rawCb_ = cb;
   rawCtx_ = ctx;
...
bool ProphEBSBackendSDK511::RegisterExtTriggerCallback(ProphEBSExtTriggerCallback cb, void* ctx)
{
   trigCb_ = cb;
   trigCtx_ = ctx;
   try
...
void ProphEBSBackendSDK511::UnregisterCallbacks()
{
...
bool ProphEBSBackendSDK511::Start()
{
   try { cam_.start(); return true; }
   catch (const std::exception&) { return false; }
}

void ProphEBSBackendSDK511::Stop()
{
   try { cam_.stop(); }
   catch (const std::exception&) {}
}

bool ProphEBSBackendSDK511::StartRecording(const char* path)
{
   try { return cam_.start_recording(path); }
   catch (const std::exception&) { return false; }
}

void ProphEBSBackendSDK511::StopRecording(const char* path)
{
...
size_t ProphEBSBackendSDK511::GetBiasCount()
{
   return biasNames_.size();
}

bool ProphEBSBackendSDK511::GetBiasInfo(size_t index, ProphEBSBiasInfo& out)
{
...
bool ProphEBSBackendSDK511::GetBiasValue(const char* name, int& out)
{
   try
   {
...
bool ProphEBSBackendSDK511::SetBiasValue(const char* name, int value, int& actualOut)
{
   try
   {
      Metavision::I_LL_Biases& biases = Facility<Metavision::I_LL_Biases>();
...
ProphEBSResult ProphEBSBackendSDK511::ErcGetRange(uint32_t& minRate, uint32_t& maxRate)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK511::EventTrailFilterGetAvailableTypes(char availableTypesCsv[128])
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK511::EventTrailFilterGetThresholdRange(uint32_t& minT, uint32_t& maxT)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK511::EventTrailFilterIsEnabled(bool& out)
{
   try { out = Facility<Metavision::I_EventTrailFilterModule>().is_enabled(); return ProphEBSResult::Ok; }
   catch (const std::exception&) { return ProphEBSResult::Unsupported; }
}

ProphEBSResult ProphEBSBackendSDK511::EventTrailFilterEnable(bool enable)
{
   try { Facility<Metavision::I_EventTrailFilterModule>().enable(enable); return ProphEBSResult::Ok; }
   catch (const std::exception&) { return ProphEBSResult::Unsupported; }
}

ProphEBSResult ProphEBSBackendSDK511::EventTrailFilterGetThreshold(uint32_t& out)
{
   try { out = Facility<Metavision::I_EventTrailFilterModule>().get_threshold(); return ProphEBSResult::Ok; }
   catch (const std::exception&) { return ProphEBSResult::Unsupported; }
}

ProphEBSResult ProphEBSBackendSDK511::EventTrailFilterSetThreshold(uint32_t value)
{
   try { Facility<Metavision::I_EventTrailFilterModule>().set_threshold(value); return ProphEBSResult::Ok; }
   catch (const std::exception&) { return ProphEBSResult::Unsupported; }
}

ProphEBSResult ProphEBSBackendSDK511::EventTrailFilterGetType(char typeOut[32])
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK511::EventTrailFilterSetType(const char* type)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK511::AntiFlickerGetThresholdRanges(
...
ProphEBSResult ProphEBSBackendSDK511::AntiFlickerGetDutyCycleRange(float& minDc, float& maxDc)
{
   try
   {
      Metavision::I_AntiFlickerModule& af = Facility<Metavision::I_AntiFlickerModule>();
...
ProphEBSResult ProphEBSBackendSDK511::AntiFlickerGetFrequencyRange(uint32_t& minFreq, uint32_t& maxFreq)
{
   try
   {
      Metavision::I_AntiFlickerModule& af = Facility<Metavision::I_AntiFlickerModule>();
...
ProphEBSResult ProphEBSBackendSDK511::AntiFlickerSetFilterType(bool isBandPass)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK511::AntiFlickerGetFrequencyBand(uint32_t& lowFreq, uint32_t& highFreq)
{
   try
   {
      Metavision::I_AntiFlickerModule& af = Facility<Metavision::I_AntiFlickerModule>();
...
ProphEBSResult ProphEBSBackendSDK511::AntiFlickerSetFrequencyBand(uint32_t lowFreq, uint32_t highFreq)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK511::TriggerInGetAvailableChannels(char channelsCsv[64])
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK511::TriggerInIsEnabled(const char* channel, bool& out)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK511::TriggerInEnable(const char* channel, bool enable)
{
   try
   {
      Metavision::I_TriggerIn::Channel ch;
...
ProphEBSResult ProphEBSBackendSDK511::TriggerOutSetPeriod(uint32_t periodUs)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK511::TriggerOutSetDutyCycle(double dutyCycle)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK511::TriggerOutEnable(bool enable)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK511::EventRateFilterGetThresholdRanges(
...
ProphEBSResult ProphEBSBackendSDK511::EventRateFilterGetThresholds(ProphEBSEventRateThresholds& out)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK511::EventRateFilterSetThresholds(const ProphEBSEventRateThresholds& value)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK511::EventRateFilterIsEnabled(bool& out)
{
   try { out = Facility<Metavision::I_EventRateActivityFilterModule>().is_enabled(); return ProphEBSResult::Ok; }
   catch (const std::exception&) { return ProphEBSResult::Unsupported; }
}

ProphEBSResult ProphEBSBackendSDK511::EventRateFilterEnable(bool enable)
{
...
ProphEBSResult ProphEBSBackendSDK511::SetSyncMode(const char* mode)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK511::RoiSetWindow(unsigned x, unsigned y, unsigned xSize, unsigned ySize)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK511::RoiDisable()
{
...
ProphEBSResult ProphEBSBackendSDK511::GetDigitalEventMaskSlotCount(size_t& out)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK511::ApplyDigitalEventMask(const unsigned* xs, const unsigned* ys, size_t count)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK511::ApplyRoiPixelMask(const unsigned* xs, const unsigned* ys, size_t count)
{
   try
   {
...
bool ProphEBSBackendSDK511::ActivityFilterConstruct(unsigned width, unsigned height, int64_t thresholdUs)
{
   try
   {
...
void ProphEBSBackendSDK511::ActivityFilterSetThreshold(int64_t thresholdUs)
{
   if (activityFilter_)
      activityFilter_->set_threshold(static_cast<Metavision::timestamp>(thresholdUs));
}

void ProphEBSBackendSDK511::ActivityFilterDestroy()
{
   activityFilter_.reset();
}

void ProphEBSBackendSDK511::ActivityFilterProcess(const ProphEBSEvent* in, size_t inCount,
