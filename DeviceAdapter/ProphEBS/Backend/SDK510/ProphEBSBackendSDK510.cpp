///////////////////////////////////////////////////////////////////////////////
// FILE:          ProphEBSBackendSDK510.cpp
// PROJECT:       Micro-Manager
// SUBSYSTEM:     DeviceAdapters / ProphEBS / Backend / SDK510
//-----------------------------------------------------------------------------
// See ProphEBSBackendSDK510.h for the design rationale. This is a 1:1
...
#include "ProphEBSBackendSDK510.h"
...
ProphEBSBackendSDK510::~ProphEBSBackendSDK510()
{
   Disconnect();
}

bool ProphEBSBackendSDK510::Connect(bool biasRangeCheckBypass, char* errorOut, size_t errorOutLen)
{
   try
   {
...
void ProphEBSBackendSDK510::Disconnect()
{
   if (connected_)
   {
...
bool ProphEBSBackendSDK510::GetIdentification(ProphEBSIdentification& out)
{
   try
   {
...
void ProphEBSBackendSDK510::RegisterCdCallback(ProphEBSCdCallback cb, void* ctx)
{
   cdCb_ = cb;
   cdCtx_ = ctx;
...
void ProphEBSBackendSDK510::RegisterRawDataCallback(ProphEBSRawDataCallback cb, void* ctx)
{
   rawCb_ = cb;
   rawCtx_ = ctx;
...
bool ProphEBSBackendSDK510::RegisterExtTriggerCallback(ProphEBSExtTriggerCallback cb, void* ctx)
{
   trigCb_ = cb;
   trigCtx_ = ctx;
   try
...
void ProphEBSBackendSDK510::UnregisterCallbacks()
{
...
bool ProphEBSBackendSDK510::Start()
{
   try { cam_.start(); return true; }
   catch (const std::exception&) { return false; }
}

void ProphEBSBackendSDK510::Stop()
{
   try { cam_.stop(); }
   catch (const std::exception&) {}
}

bool ProphEBSBackendSDK510::StartRecording(const char* path)
{
   try { return cam_.start_recording(path); }
   catch (const std::exception&) { return false; }
}

void ProphEBSBackendSDK510::StopRecording(const char* path)
{
...
size_t ProphEBSBackendSDK510::GetBiasCount()
{
   return biasNames_.size();
}

bool ProphEBSBackendSDK510::GetBiasInfo(size_t index, ProphEBSBiasInfo& out)
{
...
bool ProphEBSBackendSDK510::GetBiasValue(const char* name, int& out)
{
   try
   {
...
bool ProphEBSBackendSDK510::SetBiasValue(const char* name, int value, int& actualOut)
{
   try
   {
      Metavision::I_LL_Biases& biases = Facility<Metavision::I_LL_Biases>();
...
ProphEBSResult ProphEBSBackendSDK510::ErcGetRange(uint32_t& minRate, uint32_t& maxRate)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK510::EventTrailFilterGetAvailableTypes(char availableTypesCsv[128])
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK510::EventTrailFilterGetThresholdRange(uint32_t& minT, uint32_t& maxT)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK510::EventTrailFilterIsEnabled(bool& out)
{
   try { out = Facility<Metavision::I_EventTrailFilterModule>().is_enabled(); return ProphEBSResult::Ok; }
   catch (const std::exception&) { return ProphEBSResult::Unsupported; }
}

ProphEBSResult ProphEBSBackendSDK510::EventTrailFilterEnable(bool enable)
{
   try { Facility<Metavision::I_EventTrailFilterModule>().enable(enable); return ProphEBSResult::Ok; }
   catch (const std::exception&) { return ProphEBSResult::Unsupported; }
}

ProphEBSResult ProphEBSBackendSDK510::EventTrailFilterGetThreshold(uint32_t& out)
{
   try { out = Facility<Metavision::I_EventTrailFilterModule>().get_threshold(); return ProphEBSResult::Ok; }
   catch (const std::exception&) { return ProphEBSResult::Unsupported; }
}

ProphEBSResult ProphEBSBackendSDK510::EventTrailFilterSetThreshold(uint32_t value)
{
   try { Facility<Metavision::I_EventTrailFilterModule>().set_threshold(value); return ProphEBSResult::Ok; }
   catch (const std::exception&) { return ProphEBSResult::Unsupported; }
}

ProphEBSResult ProphEBSBackendSDK510::EventTrailFilterGetType(char typeOut[32])
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK510::EventTrailFilterSetType(const char* type)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK510::AntiFlickerGetThresholdRanges(
...
ProphEBSResult ProphEBSBackendSDK510::AntiFlickerGetDutyCycleRange(float& minDc, float& maxDc)
{
   try
   {
      Metavision::I_AntiFlickerModule& af = Facility<Metavision::I_AntiFlickerModule>();
...
ProphEBSResult ProphEBSBackendSDK510::AntiFlickerGetFrequencyRange(uint32_t& minFreq, uint32_t& maxFreq)
{
   try
   {
      Metavision::I_AntiFlickerModule& af = Facility<Metavision::I_AntiFlickerModule>();
...
ProphEBSResult ProphEBSBackendSDK510::AntiFlickerSetFilterType(bool isBandPass)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK510::AntiFlickerGetFrequencyBand(uint32_t& lowFreq, uint32_t& highFreq)
{
   try
   {
      Metavision::I_AntiFlickerModule& af = Facility<Metavision::I_AntiFlickerModule>();
...
ProphEBSResult ProphEBSBackendSDK510::AntiFlickerSetFrequencyBand(uint32_t lowFreq, uint32_t highFreq)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK510::TriggerInGetAvailableChannels(char channelsCsv[64])
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK510::TriggerInIsEnabled(const char* channel, bool& out)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK510::TriggerInEnable(const char* channel, bool enable)
{
   try
   {
      Metavision::I_TriggerIn::Channel ch;
...
ProphEBSResult ProphEBSBackendSDK510::TriggerOutSetPeriod(uint32_t periodUs)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK510::TriggerOutSetDutyCycle(double dutyCycle)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK510::TriggerOutEnable(bool enable)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK510::EventRateFilterGetThresholdRanges(
...
ProphEBSResult ProphEBSBackendSDK510::EventRateFilterGetThresholds(ProphEBSEventRateThresholds& out)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK510::EventRateFilterSetThresholds(const ProphEBSEventRateThresholds& value)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK510::EventRateFilterIsEnabled(bool& out)
{
   try { out = Facility<Metavision::I_EventRateActivityFilterModule>().is_enabled(); return ProphEBSResult::Ok; }
   catch (const std::exception&) { return ProphEBSResult::Unsupported; }
}

ProphEBSResult ProphEBSBackendSDK510::EventRateFilterEnable(bool enable)
{
...
ProphEBSResult ProphEBSBackendSDK510::SetSyncMode(const char* mode)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK510::RoiSetWindow(unsigned x, unsigned y, unsigned xSize, unsigned ySize)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK510::RoiDisable()
{
...
ProphEBSResult ProphEBSBackendSDK510::GetDigitalEventMaskSlotCount(size_t& out)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK510::ApplyDigitalEventMask(const unsigned* xs, const unsigned* ys, size_t count)
{
   try
   {
...
ProphEBSResult ProphEBSBackendSDK510::ApplyRoiPixelMask(const unsigned* xs, const unsigned* ys, size_t count)
{
   try
   {
...
bool ProphEBSBackendSDK510::ActivityFilterConstruct(unsigned width, unsigned height, int64_t thresholdUs)
{
   try
   {
...
void ProphEBSBackendSDK510::ActivityFilterSetThreshold(int64_t thresholdUs)
{
   if (activityFilter_)
      activityFilter_->set_threshold(static_cast<Metavision::timestamp>(thresholdUs));
}

void ProphEBSBackendSDK510::ActivityFilterDestroy()
{
   activityFilter_.reset();
}

void ProphEBSBackendSDK510::ActivityFilterProcess(const ProphEBSEvent* in, size_t inCount,
