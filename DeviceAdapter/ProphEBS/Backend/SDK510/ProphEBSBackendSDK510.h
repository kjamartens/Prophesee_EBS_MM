...
//                ProphEBS_Backend_SDK510.dll, loaded dynamically at runtime by
...
class ProphEBSBackendSDK510 : public IProphEBSBackend
{
public:
   ProphEBSBackendSDK510() = default;
   ~ProphEBSBackendSDK510() override;
